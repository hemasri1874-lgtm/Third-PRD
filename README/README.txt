...
Create a repository named Third-PRD.
Copy this requirement into README.md.
Write the Java program in src/Main.java.
Write the pseudocode in pseudocode/pseudocode.txt.
Run all five test cases.
Save each console output in the output folder.
Use meaningful variable names.
Do not copy another learner's code.
Do not add arrays, methods, classes, or advanced concepts.
Verify the output before submission.
